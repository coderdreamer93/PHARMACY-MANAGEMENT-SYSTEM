...
const Register = () => {
  ...
  return (
    ...
    <div className=" border-40 row r-row overflow-hidden  ">
      <div className="col-md-6 white-box pt-5 pb-5  d-flex align-items-center justify-content-center flex-column">
